...
def create_librimix(
    ...
    # Get metadata files
    print(
        "[Warning] - train-clean-360 is ignored in create_librimix_from_metadata.py for less data preparation time."
...
def add_to_mixture_metadata(
    mix_df, mix_id, abs_mix_path, abs_sources_path, abs_noise_path, length, subdir
):
